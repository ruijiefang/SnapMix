...
parser.add_argument('--testing', dest='testing', action='store_true', help='evaluate model on validation set')
...
parser.add_argument('--tta', default=None, type=int, help='config files')
...
parser.add_argument('--sp', default=0.0, type=float, metavar='M', help='probability')
parser.add_argument('--prob', type=float, default=1, help='')
...
parser.add_argument('--foldid', default=0, type=int, metavar='N', help='fold id')
